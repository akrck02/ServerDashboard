...
export const MATERIAL_ICONS = {
    ...
    "deployed_code" : `<path d="M11.25 20.15V12.425L4.5 8.52499V16.25L11.25 20.15ZM12.75 20.15L19.5 16.25V8.49999L12.75 12.4209V20.15ZM12 11.15L18.65 7.27499L12 3.42499L5.325 7.27499L12 11.15ZM3.75 17.55C3.5125 17.4096 3.32813 17.2244 3.19688 16.9947C3.06563 16.7649 3 16.5167 3 16.25V7.74999C3 7.48332 3.06563 7.2351 3.19688 7.00531C3.32813 6.77553 3.5125 6.59042 3.75 6.44999L11.25 2.12499C11.4888 1.99165 11.7402 1.92499 12.0041 1.92499C12.268 1.92499 12.5167 1.99165 12.75 2.12499L20.25 6.44999C20.4875 6.59042 20.6719 6.77553 20.8031 7.00531C20.9344 7.2351 21 7.48332 21 7.74999V16.25C21 16.5167 20.9344 16.7649 20.8031 16.9947C20.6719 17.2244 20.4875 17.4096 20.25 17.55L12.75 21.875C12.5112 22.0083 12.2598 22.075 11.9959 22.075C11.732 22.075 11.4833 22.0083 11.25 21.875L3.75 17.55Z" fill="inherit"/>`,
    "file_upload": `<path d="M5.5 20C5.1 20 4.75 19.85 4.45 19.55C4.15 19.25 4 18.9 4 18.5V14.925H5.5V18.5H18.5V14.925H20V18.5C20 18.9 19.85 19.25 19.55 19.55C19.25 19.85 18.9 20 18.5 20H5.5ZM11.25 16.175V6.9L8.25 9.9L7.175 8.825L12 4L16.825 8.825L15.75 9.9L12.75 6.9V16.175H11.25Z" fill="inherit"/>`
} 
